...
class LogDog(
    ...
    override fun log(message: String) {
        ...
        if ((message.startsWith("{") && message.endsWith("}")) || (message.startsWith("[") && message.endsWith("]"))) {
            ...
            if ((message.trim().startsWith("-->") && !message.trim().startsWith("--> END")) || (message.trim().startsWith("<--") && !message.trim().startsWith("<-- END"))) {
                print("┌────────────────────────────────────────────────────────────────────────────────────────────────────────────────")
                print("│ $message 🐶")
                print("├┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄")
            } else if (message.trim().startsWith("--> END") || message.trim().startsWith("<-- END")) {
                print("├┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄")
                print("│ $message")
                print("└────────────────────────────────────────────────────────────────────────────────────────────────────────────────")
            } else {
